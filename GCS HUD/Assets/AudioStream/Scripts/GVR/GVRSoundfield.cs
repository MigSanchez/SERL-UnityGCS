...
{
    public class GVRSoundfield : AudioStreamBase
    {
        // ========================================================================================================================================
        #region Editor
        //[Range(0f, 1f)]
        ...
        void Update()
        {
            ...
            {
                this.gvrPlugin.GVRSoundfield_SetGain(this.gain);
                ...
                this.gvrPlugin.GVRSoundfield_Set3DAttributes(
        ...
        protected override void OnDisable()
        {
            if (channel.hasHandle())
            {
                ...
                result = channel.removeDSP(this.gvrPlugin.GVRSoundfield_DSP);
                ERRCHECK(result, "channel.removeDSP", false);
            }
        ...
        protected override void StreamStarting(int samplerate, int channels, FMOD.SOUND_FORMAT sound_format)
        {
            ...
            this.gvrPlugin.GVRListener_SetRoomProperties();
            ...
            channel.addDSP(1, this.gvrPlugin.GVRSoundfield_DSP);
            ERRCHECK(result, "channel.addDSP");
        }
